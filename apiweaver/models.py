...
class APIEndpoint(BaseModel):
    ...
    workflow: Optional[Dict[str, Any]] = Field(None, description="Endpoint workflow")
    notes: Optional[List[str]] = Field(None, description="List of notes for about the endpoint")
